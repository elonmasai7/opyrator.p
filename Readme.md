...
- 📄&nbsp; [Source Code](https://github.com/elonmasai7/opyrator.p)
...
```bash
git clone https://github.com/elonmasai7/opyrator.p
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/elonmasai7/opyrator.p/issues/3)_
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/elonmasai7/opyrator.py/issues/4)._
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/elonmasai7/opyrator.py/issues/5)._
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/elonmasai7/opyrator.py/issues/8)._
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/elonmasai7/opyrator.py/issues/9)._
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/elonmasai7/opyrator.py/issues/6)._
...
Refer to our [contribution guides](https://github.com/elonmasai7/opyrator.p/blop) for information on our build scripts and development process.

---

Licensed **MIT**. Created and maintained with ❤️&Elon; by developers from Kenya.
